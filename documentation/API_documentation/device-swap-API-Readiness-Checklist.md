...
Checklist for device-swap 0.2.0-rc.1 in r2.1
...
|  8 | Enhanced API test cases & documentation      |   O   |         O         |    O    |    M   |   N  | pending |
|  9 | Test result statement                        |   O   |         O         |    O    |    M   |   N  |  Spring25 EXCEPTION: Test results not available (*)    |
